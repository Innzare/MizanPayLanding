...
const faqs = [
  ...
  },
  {
    ...
    a: 'В обычной рассрочке банк выдаёт деньги под проценты. В MizanPay компания сама покупает товар и продаёт клиенту с фиксированной наценкой. Цена фиксируется на весь срок — никаких скрытых комиссий и штрафов.',
  },
  {
    q: 'Как стать партнёром?',
    a: 'Заполните заявку на странице «Стать партнёром». Мы рассмотрим её в течение 1-3 рабочих дней, проверим документы и откроем доступ к платформе.',
  },
  {
  ...
  },
  {
    ...
    a: 'Мы рекомендуем связаться с компанией через платформу. В большинстве случаев можно договориться о пересмотре графика. MizanPay не начисляет штрафы и пени.',
  },
  {
    q: 'Безопасно ли пользоваться платформой?',
    a: 'Да. Все компании проходят верификацию. Сделки оформляются договором. Данные защищены шифрованием. Мы работаем в соответствии с законодательством РФ.',
  },
]
</script>
