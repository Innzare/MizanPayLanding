...
const plans: {
  ...
  },
  {
    ...
    features: [
      ...
      { text: 'Со-инвесторы', included: false },
      { text: 'Графики и Excel, Импорт', included: false },
      { text: 'Сотрудники, WhatsApp', included: false },
    ],
  },
  {
    name: 'Бизнес',
    ...
    popular: true,
    tier: 'business',
    deals: 'До 150 активных сделок',
    responsePrice: '100 ₽ / отклик',
    features: [
      { text: 'Все функции Стандарта', included: true },
      { text: 'Со-инвесторы и пул капитала', included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: 'Сотрудники с ролями и чатом', included: true },
